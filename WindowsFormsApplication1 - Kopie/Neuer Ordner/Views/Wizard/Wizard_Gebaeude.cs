...
{
    public partial class Wizard_Gebaeude : Form
    {
        ...
        public Wizard_Gebaeude()
        {
            ...
            listView_Gebaeude.Columns.Add("Gebäudename", -2, HorizontalAlignment.Left);
            listView_Gebaeude.Columns.Add("ID_Gebäude", -2, HorizontalAlignment.Left);
