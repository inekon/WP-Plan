        ...
        private void ContextMenuItemBearbeiten_Click(object sender, EventArgs e)
        {
            ...
            if (indexes.Count > 0)
            {
                ...
                string sql = "SELECT Z_ProjektGebaeude.ID, Z_ProjektGebaeude.ID_Gebaeude, Z_ProjektGebaeude.[ID_Projekt], " +
                    ...
                    " where Z_ProjektGebaeude.ID_Projekt=" + m_ID_Projekt + " and [DBGebaeude].Gebaeudename='" + lvitem.Text + "' and Z_ProjektGebaeude.ID=" + lvitem.SubItems[4].Text;
                ...
                {
                    wizctrl.Del_Projekt_ZuordungGebäude(m_ID_Projekt, item.ID_Z);
