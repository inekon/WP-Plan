    ...
    public partial class Form_WP : Form
    {
        ...
        private void InitChart(string mode)
        {
            ...
            for (int i = 0; i < ctrl.rows; i++)
            {
                ...
                chart1.Series[i].MarkerColor = Color.Blue;
                ...
                chart2.Series[i].MarkerSize = 3;
                chart2.Series[i].MarkerStyle = MarkerStyle.Square;
                chart2.Series[i].MarkerColor = Color.Blue;
